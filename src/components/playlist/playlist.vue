  ...
  <transition name="list-fade">
    <div class="playlist" v-show="showFlag" @click="hide">
      <div class="list-wrapper" @click.stop>
        ...
        <v-scroll :refreshDelay="refreshDelay" class="list-content" :data="sequenceList" ref="listContent">
        ...
        <div class="list-operate">
          <div class="add" @click="addSongBtn">
            <i class="icon-add"></i>
    ...
    <v-confirm @confirm="confirmClear" ref="confirm" text="是否清空播放列表" confirmBtnText="清空"></v-confirm>
    <v-add-song ref="addSongs"></v-add-song>
    </div>
  </transition>
</template>
